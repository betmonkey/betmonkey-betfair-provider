...
import static com.betmonkey.enums.MarketProjection.RUNNER_DESCRIPTION;
 ...
 * 
 */
public class BetfairProviderDemo {

	private BetfairDataProvider rescriptOperations = BetfairDataProvider.getInstance();
    ...
    public void start() {
        ...
        } catch (DataRetrievalException apiExc) {
    ...
    private static double getPrice() {
        ...
        try {
            return new Double((String) BetfairDemoRunner.getProp().get("BET_PRICE"));
    ...
    private static double getSize(){
        try{
            return new Double((String) BetfairDemoRunner.getProp().get("BET_SIZE"));
        } catch (NumberFormatException e){
            //returning the default value
